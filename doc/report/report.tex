...
La régression linéaire constitue un modèle paramétrique dans lequel la sortie est exprimée comme une combinaison affine des variables d’entrée. Dans notre cas, elle est utilisée pour approximer la fonction \( f : \mathbb{R}^4 \rightarrow \mathbb{R}^{2N} \) reliant les conditions initiales à la trajectoire de la bille.
