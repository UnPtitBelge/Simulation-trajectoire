...
try:
    from src.model.ml.sim_to_real.model_utils import train_and_evaluate, _MODELS_PKL
...
def main():
    ...
    try:
        ...
        if not os.path.exists(_SYNTHETIC_NPZ):
            ...
            log.error("Please generate the synthetic data first using generate_synthetic_data.py")
            return 1
